(function () {
  ...
  window.NaturalehiaInstrumentFixture = {
    meta: {
      ...
      assumedInvestorDiscountRatePercent: 8,
      claimCount: 10,
      scenarioCount: 9,
      factorCount: 5,
      verification: {
    ...
    constructions: {
      core: {
        ...
        resolvedLossProbability: "37%",
        hurdle: "At assumed 8% discount rate",
        es95: 70.803,
        es99: 90,
        title: "A positive center does not make a robust asset.",
        copy: "At the assumed 8% investor discount rate, central NPV is only 0.662, while a permitted adverse probability mix produces an 18.718 shortfall. The unsupported claim is measurable, but not yet shown investable.",
      ...
      stack: {
        ...
        retainedLoss: 9.9806,
        continuingExposure: 8.52,
        resolvedLossProbability: "37% pool / 17% priority",
        hurdle: "Aggregate at assumed common 8% discount rate",
        es95: 70.803,
        es99: 90,
        title: "Priority moves loss; prefunding consumes value.",
        copy: "Twenty of funded first-loss capital protects the 20–100 priority claim, but the whole commitment is paid at the start. The resulting prefunding drag leaves both classes below their assumed central discount rates.",
    ...
    comparison: [
      { key: "core", label: "Unsupported core", central: 0.661828, adverse: -18.717674, note: "assumed 8% discount rate" },
