...
\fancyhead[R]{\footnotesize\color{Rust}\textsc{Technical White Paper / Version 1.1}}
...
\begin{titlepage}
  ...
  \begin{tabularx}{\textwidth}{@{}P{0.27\textwidth}Y@{}}
    ...
    \textbf{Version} & 1.1 / 1 September 2026\\
...
\begin{itemize}
  ...
  \item verification status: 70 of 70 declared tests pass in the current strict C++20 Emscripten 6.0.5 Release/Node suite, including the v0.2 asset-to-liability bridge and direct Claim Ledger integration;
  \item portable execution: the release evidence reported for version 1.1 is produced by the pinned Emscripten container and Node, including every command-line report wrapper;
