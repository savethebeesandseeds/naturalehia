...
\hypersetup{
  ...
  pdfsubject={Open financial engineering for cellular agriculture, published by Waajacu Open Source Foundation},
...
\fancyhead[R]{\footnotesize\color{Rust}\textsc{Working Paper / Version 2.1}}
...
\thispagestyle{empty}
\vspace*{-12mm}
{\small\bfseries\color{Rust}\MakeUppercase{Waajacu Open Source Foundation \enspace/\enspace Financial Engineering Working Paper}}\par
\vspace{7mm}
...
\begin{tabularx}{\textwidth}{@{}P{0.20\textwidth}Y@{}}
  \textbf{Author} & Santiago Restrepo Ruiz\\
  \textbf{Publisher} & Waajacu Open Source Foundation\\
  \textbf{Version} & 2.1 / 1 September 2026\\
  \textbf{Model case} & Ten synthetic project claims; 100 reference principal; 60-month horizon\\
  \textbf{Correspondence} & \href{mailto:Santiago.Restrepo.Ruiz@gmail.com}{\nolinkurl{Santiago.Restrepo.Ruiz@gmail.com}}; \href{https://waajacu.com}{waajacu.com}\\
...
\begin{itemize}
  ...
  \item verification status: the complete current warnings-as-errors C++20 Emscripten 6.0.5 Release build and Node-driven suite passed 75 of 75 declared tests on 1 September 2026. The ten-claim quantitative kernel and reported outputs are unchanged from the version 1.3 release; the two added targets verify the funding-bridge evaluator and its closed configuration parser;
  \item immutable release identity: tag \texttt{fca-whitepaper-v2.1.0}; the tagged \href{https://github.com/savethebeesandseeds/naturalehia/blob/fca-whitepaper-v2.1.0/projects/fostering-cellular-agriculture/whitepaper/release-manifest-v2.1.tsv}{release manifest} records the paper-relevant source, fixture, funding-bridge and released-PDF hashes;
  \item publication boundary: the released \href{https://github.com/savethebeesandseeds/naturalehia/blob/fca-whitepaper-v2.1.0/projects/fostering-cellular-agriculture/docs/CALLABLE_CAPITAL_WAREHOUSE_FUNDING_BRIDGE_V0_1.md}{Callable-Capital and Warehouse Funding Integrity Bridge v0.1} now has checked accounting, provider-lineage, eligibility, maturity and nonanticipativity mechanics, but no checked file-backed transaction or numerical candidate result;
  ...
  \item paper toolchain: \texttt{latexmk} inside the persistent project container based on the digest-pinned \texttt{emscripten/emsdk:6.0.5} image.
\end{itemize}
...
The next serious step is empirical: acquire enforceable project cash rights, milestone and recovery data, joint-risk evidence, investor price/hurdle observations and provider capacity terms in the common interface. The nonanticipative funding-liquidity bridge now passes its synthetic accounting, eligibility, provider-lineage, maturity and policy-timing controls. It does not yet have a checked file-backed transaction, empirical facility evidence or a numerical candidate result, so this paper claims no funding saving. With admissible facts and mechanics, the framework can test whether a revised instrument is valuable, what risks it distributes across projects and institutions, and how much explicit catalytic support is genuinely required.
...
\textbf{Authorship and responsibility.} Santiago Restrepo Ruiz is the author and assumes responsibility for the research question, evidence boundary, model specification, calculations and release decision.\\
\textbf{Publisher.} Waajacu Open Source Foundation publishes this working paper and the open financial-engineering standard. Publication does not endorse or admit any named issuer, investor, guarantor or project.\\
\textbf{Author economics.} The author and Waajacu retain no protocol fee, carried interest, instrument royalty or share of financed-company receipts from adoption of the published standard.\\
...
\textbf{Computational assistance.} OpenAI Codex was used for research assistance, drafting, code generation and review, and release verification. It is not an author and cannot assume scholarly responsibility. All claims, model boundaries, source selection, code, tests and release decisions remain the human author's responsibility.\\
\textbf{External review.} This working paper has not been externally peer reviewed.\\
\textbf{Data and code.} Source, configurations, documentation and tests for this paper are fixed by release tag \href{https://github.com/savethebeesandseeds/naturalehia/tree/fca-whitepaper-v2.1.0/projects/fostering-cellular-agriculture}{\texttt{fca-whitepaper-v2.1.0}}. The numerical case is synthetic.\\
