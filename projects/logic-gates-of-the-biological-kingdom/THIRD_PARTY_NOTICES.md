...
| CMake, Ninja, GCC, Clang, ShellCheck, Uncrustify, and related Debian packages | Build and quality tools | Each package retains its upstream and Debian licensing terms. Exact installed versions are recorded in `/work/toolchain-packages.tsv`. |
